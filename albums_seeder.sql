...
VALUES ('Michael Jackson'       , 'Thriller'                               , 1982 , 46.0 , 'ROCK'),
       ('AC/DC'                 , 'Back in Black'                          , 1980 , 26.1 , 'ROCK'),
       ('Pink Floyd'            , 'The Dark Side of the Moon'              , 1973 , 24.2 , 'ROCK'),
       ('Whitney Houston'       , 'The Bodyguard'                          , 1992 , 27.4 , 'R&B'),
       ('Meat Loaf'             , 'Bat Out of Hell'                        , 1977 , 20.6 , 'ROCK'),
       ...
       ('Alanis Morissette'	    , 'Jagged Little Pill'                     , 1995 , 24.8 , 'ROCK'),
